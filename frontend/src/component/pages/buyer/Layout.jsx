          ...
          <header className="topbar">
            ...
            <div className="topbar-right">
              ...
              <div className="dropdown-wrap" ref={chatMsgRef}>
                ...
                <div className={`dropdown-menu notif-menu ${chatMsgOpen ? "open" : ""}`}>
                      ...
                      chatUnreadData.map(chat => {
                        ...
                        return (
                          <div key={chat.chat_id} className="notif-item unread"
                            onClick={() => { setChatMsgOpen(false); navigate("/buyer/chats", { state: { openChatId: chat.chat_id } }); }}>
                  ...
                  <div className="notif-footer">
                    <button className="notif-footer-link" onClick={() => { setChatMsgOpen(false); navigate("/buyer/chats"); }}>
              ...
              {/* ── Notifications dropdown ─────────────────────────────────────────
                   ...
                   "View all notifications" navigates to /buyer/notifications.
              ──────────────────────────────────────────────────────────────── */}
              <div className="dropdown-wrap" ref={notifRef}>
                ...
                <div className={`dropdown-menu notif-menu ${notifOpen ? "open" : ""}`}>
                  ...
                  {/* ── Footer: always navigates to /buyer/notifications ── */}
                  <div className="notif-footer">
                    <button
                      className="notif-footer-link"
                      onClick={() => { setNotifOpen(false); navigate("/buyer/notifications"); }}
                    >
              ...
              <div className="dropdown-wrap" ref={profileRef}>
                ...
                <div className={`dropdown-menu profile-menu ${profileOpen ? "open" : ""}`}>
                  ...
                  <div className="profile-actions">
                    ...
                    <button className="profile-action-item" onClick={() => { setProfileOpen(false); navigate("/buyer/chats"); }}>
