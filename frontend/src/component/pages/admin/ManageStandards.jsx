        ...
        <div className="standard-card">
            <div className="standard-card-header">
                <div className="standard-card-title">
                    ...
                    <span className="standard-id">#{standard.id}</span>
                </div>
            ...
            <div className="standard-card-body">
                <div className="standard-buyer-info">
                    <Users size={14} />
                    <span>{standard.created_by_details?.full_name || 'Unknown Buyer'}</span>
                </div>
                ...
                <div className="standard-quantity-range">
                    <div className="quantity-item">
                        ...
                        <span className="quantity-value">{standard.min_quantity} kg</span>
                    </div>
                    {standard.max_quantity && (
                        <div className="quantity-item">
                            <span className="quantity-label">{t('max')}:</span>
                            <span className="quantity-value">{standard.max_quantity} kg</span>
                        </div>
                    )}
                </div>
                        ...
                        <tr key={standard.id}>
                            ...
                            <td>
                                <div className="buyer-info">
                                    <span className="buyer-name">{standard.created_by_details?.full_name}</span>
                                    <span className="buyer-phone">{standard.created_by_details?.phone_number}</span>
                                </div>
                            </td>
                            <td>
            ...
            <div className="modal standard-detail-modal">
                ...
                <div className="standard-detail-summary">
                    <div className="summary-item">
                        <span className="summary-label">{t('buyer')}</span>
                        <span className="summary-value">{standard.created_by_details?.full_name}</span>
                        <span className="summary-subvalue">{standard.created_by_details?.phone_number}</span>
                    </div>
                    <div className="summary-item">
...
export default function AdminStandardsManagement() {
    const { t } = useTranslation();
    ...
    const fetchStandards = useCallback(async (params) => {
        ...
        try {
            ...
            const response = await apiClient.get(`/admin/standards/?${queryParams}`, {
    ...
    const fetchStats = useCallback(async () => {
        try {
            const response = await apiClient.get('/admin/standards/summary/');
            if (response.data) {
    ...
    const handleDeleteStandard = async (standardId) => {
        ...
        try {
            const response = await apiClient.delete(`/admin/standards/${standardId}/delete/`);
            if (response.data) {
    ...
    const handleSubmitStandard = async (formData) => {
        ...
        try {
            const url = editingStandard
                ? `/admin/standards/${editingStandard.id}/update/`
                : '/admin/standards/create/';
        ...
        <div className="crop-standards-container">
            ...
            <div className="page-header">
                <div className="header-left">
                    ...
                    <p>{t('manage_buyer_crop_standards')}</p>
                </div>
            ...
            <div className="summary-cards">
                ...
                />
                <SummaryCard
                    title={t('unique_buyers')}
                    value={stats.unique_buyers}
                    icon={<Users size={24} />}
                    color="#7e22ce"
                    bgColor="#f3e8ff"
                />
