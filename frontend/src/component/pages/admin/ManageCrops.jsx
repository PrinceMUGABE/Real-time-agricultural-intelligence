...
function StockDetailModal({ stock, onClose, onAddMovement, onEditMovement, onDeleteMovement, t }) {
    ...
    const fetchMovements = useCallback(async () => {
        ...
        try {
            ...
            const response = await apiClient.get(`/stocks/${stock.id}/movements/?${params}`, {
...
export default function ManageCrops() {
    ...
    const fetchStocks = useCallback(async (params) => {
        ...
        try {
            ...
            const response = await apiClient.get(`/stocks/?${queryParams}`, {
                signal: abortControllerRef.current.signal
            });
    ...
    const handleDeleteMovement = async (movementId) => {
        ...
        try {
            ...
            if (response.data) {
                ...
                if (selectedStock) {
                    const stockResponse = await apiClient.get(`/stocks/${selectedStock.id}/`);
    ...
    const handleViewStock = async (stock) => {
        try {
            const response = await apiClient.get(`/stocks/${stock.id}/`);
            if (response.data) {
